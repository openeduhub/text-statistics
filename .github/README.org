...
#+begin_src sh :results verbatim :exports both
curl -d '{"url": "https://de.wikipedia.org/wiki/Deutschland"}' -H "Content-Type: application/json" -X POST localhost:8080/analyze-text | json
#+end_src

#+RESULTS:
: {
:   "flesch-ease": 36.20501491952905,
:   "classification": "Schwer",
:   "reading-time": 11937.790794813647,
:   "text": <long text>
: }
